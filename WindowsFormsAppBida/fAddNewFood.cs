...
namespace WindowsFormsAppBida
{
    public partial class fAddNewFood : Form
    {
        ...
        private void btnAddFoodNew_Click_1(object sender, EventArgs e)
        {
            ...
            decimal price = (decimal)nmFoodPriceNew.Value;
        ...
        private void nmFoodPriceNew_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (nmFoodPriceNew.Text.Length >= 7 && !char.IsControl(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void nmFoodSalaryNew_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (nmFoodSalaryNew.Text.Length >= 5 && !char.IsControl(e.KeyChar))
            {
                e.Handled = true;
