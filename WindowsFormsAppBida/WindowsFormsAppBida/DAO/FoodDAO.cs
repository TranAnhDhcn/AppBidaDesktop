...
namespace WindowsFormsAppBida.DAO
{
    public class FoodDAO
    {
        ...
        public bool InsertFood(string name, int id, int salary, float price, byte[] image)
        {
        ...
        public bool UpdateFood(int foodId, string name, int id, int salary, float price, byte[] image)
        {
