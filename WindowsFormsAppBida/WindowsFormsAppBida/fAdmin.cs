...
namespace WindowsFormsAppBida
{
    public partial class fAdmin : Form
    {
        ...
        private void btnViewBill_Click_1(object sender, EventArgs e)
        {
            ...
            lbTotalRevenue.Text = $"{decimal.Parse(dt.Rows[0]["TotalPrice"].ToString()):N0} VNĐ";
        ...
        private void btnEditFood_Click(object sender, EventArgs e)
        {
            ...
            float price = float.Parse(nmFoodPrice.Text);
        ...
        private void dtgvTable_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dtgvTable.Columns[e.ColumnIndex].Name == "ColumnActive")
            {
                if (TableDAO.Instance.getStatusLoraMesh(id) == 0)
                {
                    ...
                    StartServer.Instance.sendMessage(addTable);
        ...
        private void btnDay_Click_1(object sender, EventArgs e)
        {
            ...
            DataTable dt = BillDAO.Instance.GetTotalRevenueDay(day);

            lbTotalRevenue.Text = $"{decimal.Parse(dt.Rows[0]["TotalPriceToday"].ToString()):N0} VNĐ";
        ...
        private void btnWeek_Click_1(object sender, EventArgs e)
        {
            ...
            lbTotalRevenue.Text = $"{decimal.Parse(dt.Rows[0]["TotalPriceWeek"].ToString()):N0} VNĐ";
        ...
        private void btnMonth_Click(object sender, EventArgs e)
        {
            ...
            lbTotalRevenue.Text = $"{decimal.Parse(dt.Rows[0]["TotalPriceMonth"].ToString()):N0} VNĐ";
        ...
        private void btnYear_Click(object sender, EventArgs e)
        {
            ...
            lbTotalRevenue.Text = $"{decimal.Parse(dt.Rows[0]["TotalPriceYear"].ToString()):N0} VNĐ";
        ...
        private void btnSumitEditPrice_Click(object sender, EventArgs e)
        {
            ...
            if (!isOccupied)
            {
                ...
                else if (txbPriceBidaPlay.Text.StartsWith("0"))
                {
                    MessageBox.Show("Giá trị tiền không hợp lệ!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
        ...
        private void cbSelectClassficationTablePrice_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txbPriceNowBida.Text = PriceBidaPlay.Instance.PriceNom().ToString();
            }
            else
            {
                txbPriceNowBida.Text = PriceBidaPlay.Instance.PriceVip().ToString();
            }
        }
