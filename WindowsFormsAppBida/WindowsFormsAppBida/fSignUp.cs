...
namespace WindowsFormsAppBida
{
    public partial class fSignUp : Form
    {
        ...
        private void btnSignUp_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng quét thẻ mã số", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            ...
            else
            {
                ...
                try
                {
                    if (InsertAdmin(email, name, sex, PassWord, phone, type, arr, idCard))
                    {
