...
namespace WindowsFormsAppBida.DAO
{
    public class CategoryDAO
    {
        ...
        public Category GetCategoryByID(int id)
        {
            ...
            string query = "select * from FoodCategory where active = 1 and id = " + id;
        ...
        public bool EditActiveFoodCategory(int id)
        {
            string query = string.Format("update FoodCategory set active = 0 where id = {0}", id);
            int result = DataProvider.Instance.ExecuteNonQuery(query);
